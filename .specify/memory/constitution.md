...
“入梦 (Oneiria)” is a lightweight desktop local client. Its primary purpose is to serve as a secure connector to external AI services via user-provided API tokens. It DOES NOT perform local AI computation (inference) and MUST NOT bundle large model weights.
