...
_Derived from file system scan of output directory_
...
_Stored via `tauri-plugin-store`_

| Field        | Type     | Description                  | Default                                        |
| ------------ | -------- | ---------------------------- | ---------------------------------------------- |
| `api_url`    | `string` | AI Service Endpoint          | "https://api.openai.com/v1/images/generations" |
| `output_dir` | `string` | Custom output directory path | `~/Documents/Oneiria/Outputs`                  |
| `theme`      | `string` | UI Theme                     | "system"                                       |

### 4. GenerationRequest (Transient)

_Passed from Frontend to Rust Backend_
