# Research: DreamIn MVP

**Feature**: DreamIn MVP (Creative Studio, Resource Library, Assets Gallery)
**Date**: 2026-01-16
**Status**: Completed
...
**Rationale**:
- **Simplicity**: DreamIn has moderate state complexity (current prompt, list of resources, gallery cache). Zustand offers a minimal boilerplate API compared to Redux.
...
**Rationale**:
- **Aesthetics**: Provides a clean, modern, "airy" look (fitting "Oneiria/DreamIn" theme) out of the box.
...
- **Structure**: `Documents/DreamIn/Resources` (inputs) and `Documents/DreamIn/Outputs` (generations).
